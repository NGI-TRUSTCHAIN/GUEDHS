...
def generate_custodian(number_of_datasets):
    ...
    custodian = {"id": custodian_id, "datasets_list": list_datasets}
    return custodian
        ...
        if choice == "1":
            ...
            while aux == 0:
                ...
                if check == 1:
                    ...
                    print(
                        "The dataset typed does not exist. Please select a dataset that exists or type 0 to leave."
                    )
            if aux == 2:
                return -1
            else:
        ...
        "DataOperationRules": [
            {
                ...
                "ExpirationDate": generate_random_timestamp(),
                "Rules": random.choice(
                    ["always grant", "conditional access", "never grant"]
                ),
                "RuleID": generate_random_id("rule"),
            }
        ],
...
def generate_base_data():
    data = {"AuditingService": [], "ResourceCreation": [], "DataOperationRules": []}
    return data
